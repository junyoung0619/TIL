...
public class SortTest {
	public static void main(String[] args) {
		...
		Collections.sort(persons,new PersonComparator()); // 알파벳 순서대로, 오름차순으로 정렬.
		// 사용자 정의클래스를 사용한 리스트는 기본적으로 정렬할 수 없음!
		// Comparable 인터페이스 구현 or Comparator 클래스를 정의 (Comparator 인터페이스를 구현해서)	
		// - 비교 기준이 없으므로 사용자 정의 클래스에 비교 기준을 만들어준다.
 		
		// 문자 => 정수로 표현(0~65535)
		System.out.println(persons);
		// 만약 숫자의 리스트이면 수의 크기의 오름차순으로 정렬.
	}
}
